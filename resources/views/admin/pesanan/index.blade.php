                ...
                <table class="table" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pesanan.cetak', ['id' => $quotation->id]) }}" class="btn btn-primary"><i class="ti-pencil-alt"></i></a>
                                {{-- Hapus --}}
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#DeleteProduk{{ $quotation->id }}">
                                    <i class="ti-trash"></i>
                                </button>
                                <!-- Modal Konfirmasi Hapus -->
                                <div class="modal fade" id="DeleteProduk{{ $quotation->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $quotation->id }}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel{{ $quotation->id }}">Konfirmasi Hapus</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('produk.destroy', $quotation->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
