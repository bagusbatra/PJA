...
@section('kontenAdmin')
    <div class="container">
        ...
        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data" class="TambahProduk"
            id="myForm">
            @csrf
            <div>
                <label class="label" for="nama_produk">Nama Produk</label>
                <input class="input" type="text" id="nama_produk" name="nama_produk" placeholder="Masukkan Nama Produk"
                    required>
            </div>
            <div>
                <label class="label" for="price">Harga</label>
                <input class="input" type="text" id="price" name="price" placeholder="Masukkan Harga Produk"
                    required>
            </div>
            <div>
                <label class="label" for="tipe_produk">Tipe Produk</label>
                <input class="input" type="text" id="tipe_produk" name="tipe_produk" placeholder="Masukkan Tipe Produk"
                    required>
            </div>
            <div>
            ...
            <div>
                ...
                <textarea class="inputketerangan" id="keterangan" name="keterangan" rows="4"
                    placeholder="Masukkan Keterangan Produk" required></textarea>
            </div>
            <div>
