                ...
                <table class="table" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('produk.edit', ['id' => $produk->id]) }}" class="btn btn-primary"><i class="ti-pencil-alt"></i></a>
                                {{-- Hapus --}}
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#DeleteProduk{{ $produk->id }}">
                                    <i class="ti-trash"></i>
                                </button>
                                <!-- Modal Konfirmasi Hapus -->
                                <div class="modal fade" id="DeleteProduk{{ $produk->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $produk->id }}" aria-hidden="true">
