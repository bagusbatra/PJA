...
<<<<<<< HEAD
                    ...
                    <!-- Pesanan Masuk dan Pesanan Diproses -->
                    <div class="row pt-3">
                        <div class="col-lg-6">
                            <h4 class="card-title box-title"><b>Pesanan Masuk</b></h4>
                            <div class="card scroll">
                                <div class="table-pesananMasuk ov-h">
=======
                </div>
            ...
            <div class="row pt-3">
                <div class="col-lg-6">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @php
                                        $nomor = 1;
                                    @endphp
                                    @foreach ($new_transactions as $item)
                                        <tr>
                                            <td class="serial">{{ $nomor++ }}</td>
                                            <td><span class="name">{{ $item->user->name }}</span></td>
                                            <td><span class="email">{{ $item->user->email }}</span></td>
                                            <td><span class="date">{{ $item->created_at }}</span></td>
                                            <td>
                                                <a href="{{ route('transaction.edit', $item->id) }}">
                                                    <span class="badge badge-complete">Update</span></a>
                                            </td>
                                            <td>
                                                <span class="badge badge-complete">{{ $item->status }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="buttonPS align-center mb-5">
                        <a href="#">Detail</a>
                    </div>
                </div>

                <div class="col-lg-6">
                    <h4 class="card-title box-title"><b>Pesanan Diproses</b></h4>
                    <div class="card scroll">
                        <div class="table-pesananProses ov-h">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    @php
                                        $nomor = 1;
                                    @endphp
                                    @foreach ($proceed_transactions as $item)
                                        <tr>
                                            <td class="serial">{{ $nomor++ }}</td>
                                            <td><span class="name">{{ $item->user->name }}</span></td>
                                            <td><span class="email">{{ $item->user->email }}</span></td>
                    ...
                    <div class="buttonPS align-center">
                        <a href="#">Detail</a>
                    </div>
                </div>
            </div>
            ...
            <hr>
            <!-- Orders -->
            <div class="orders pb-5">
                <div class="row">
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="box-title"><b>Riwayat Pesanan</b></h3>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body scroll">
                                <div class="table-riwayatPesanan ov-h">
>>>>>>> 58132d0c69e06bea5abf5330fbf42a8f02cab17f
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="serial">1234</td>
                                                <td><span class="name">Louis Stanley</span></td>
                                                <td><span class="email">louis@gmail.com</span></td>
                                                <td><span class="date">12/12/2012</span></td>
                                                <td>
                                                    <span class="badge badge-complete">Lihat</span>
                                                </td>
                                                <td>
